...
const translations = {
    ...
    en: {
       ...
       about_title: "Who is Luis?",
        ...
        proj1_desc: "Desktop application developed with Python and PyQt6 for hospital bed management.",
        proj1_li1: "Integrated MySQL and PostgreSQL databases.",
        proj1_li2: "Implemented REST APIs for real-time communication.",
        proj1_li3: "Created intuitive GUI for healthcare professionals.",
        proj1_li4: "Structured system following best practices for modularization.",
        proj1_tech: "Technologies: Python, PyQt6, MySQL, PostgreSQL, REST API",

        proj2_title: "Robber Game",
        proj2_desc: "2D game developed with Unity and C#, focusing on gameplay logic and player interaction.",
        proj2_li1: "Developed stealth mechanics and enemy detection.",
        proj2_li2: "Implemented movement and collision systems.",
        proj2_li3: "Worked with events and scripts to control game behavior.",
        proj2_li4: "Structured game logic using object-oriented programming.",
        proj2_tech: "Technologies: C#, Unity",

        proj3_title: "Ritmo",
        proj3_desc: "Responsive web marketplace for sports event registration.",
        proj3_li1: "Built frontend using React/TypeScript.",
        proj3_li2: "Implemented backend in Java with PostgreSQL.",
        proj3_li3: "Supports multiple registrations across different events.",
        proj3_li4: "Focused on scalability and user experience.",
        proj3_tech: "Technologies: TypeScript, React, Java, PostgreSQL",
        ...
        book4:"Space Trilogy",
        book6:"The prince",
        book7:"Social Physics",
        book8:"Team of Teams",
        book9:"Flow - The psychology of optimal experience",
        lang_en: "English",
        lang_fi: "Finnish",
    ...
    pt: {
        ...
        proj1_desc: "Aplicação desktop desenvolvida com Python e PyQt6 para gerenciamento de leitos hospitalares.",
        proj1_li1: "Integrei bancos de dados MySQL e PostgreSQL.",
        proj1_li2: "Implementei APIs REST para comunicação em tempo real.",
        proj1_li3: "Criei interface gráfica intuitiva para profissionais da saúde.",
        proj1_li4: "Estruturei o sistema seguindo boas práticas de modularização.",
        proj1_tech: "Tecnologias: Python, PyQt6, MySQL, PostgreSQL, REST API",

        proj2_title: "Jogo do Ladrão",
        proj2_desc: "Jogo 2D desenvolvido com Unity e C#, focado em lógica de gameplay e interação do jogador.",
        proj2_li1: "Desenvolvi mecânicas de furtividade e detecção por inimigos.",
        proj2_li2: "Implementei sistema de movimentação e colisão.",
        proj2_li3: "Trabalhei com eventos e scripts para controle de comportamento do jogo.",
        proj2_li4: "Estruturei a lógica do jogo utilizando programação orientada a objetos.",
        proj2_tech: "Tecnologias: C#, Unity",

        proj3_title: "Ritmo",
        proj3_desc: "Marketplace web responsivo para inscrição em eventos esportivos.",
        proj3_li1: "Desenvolvi frontend em React/TypeScript.",
        proj3_li2: "Implementei backend em Java com PostgreSQL.",
        proj3_li3: "Permite múltiplas inscrições em diferentes eventos.",
        proj3_li4: "Foco em escalabilidade e experiência do usuário.",
        proj3_tech: "Tecnologias: TypeScript, React, Java, PostgreSQL",
        ...
        book6:"O Príncipe",
        book7:"Física Social",
        book8:"Equipe de Equipes",
        book9:"Fluxo - A psicologia da experiência ideal",
        lang_en: "Inglês",
        lang_fi: "Finlandês",
        Books: "Livros",
